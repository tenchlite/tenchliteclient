...
public class Nylocas extends Room
{
    ...
    protected void startTimer()
    {
        ...
        if (!active)
        {
            net.runelite.client.plugins.tobstats.rooms.Nylocas.bonusroom.Nylocas.Nylocas.setWave31Callback(() ->
            {
            ...
            net.runelite.client.plugins.tobstats.rooms.Nylocas.bonusroom.Nylocas.Nylocas.setEndOfWavesCallback(() ->
            {
                int millis = getCurrentMillis();
    ...
    protected void reset()
    {
        ...
        net.runelite.client.plugins.tobstats.rooms.Nylocas.bonusroom.Nylocas.Nylocas.setEndOfWavesCallback(null);
        net.runelite.client.plugins.tobstats.rooms.Nylocas.bonusroom.Nylocas.Nylocas.setWave31Callback(null);
